...
def network_construct(structure='densenet121',dropout=0.5, hidden_layer1 = 1024,lr = 0.001,device='gpu'):
    ...
    classifier = nn.Sequential(OrderedDict([
            ...
            ('relu1', nn.ReLU()),
            ('hidden_layer1', nn.Linear(hidden_layer1, 120)),
            ('relu2',nn.ReLU()),
...
def do_deep_learning(model, criterion, optimizer, epochs = 6, print_every=40, loader=0, device='gpu'):
    steps = 0
...
def save_checkpoint(model=0,path='checkpoint.pth',structure ='densenet121', hidden_layer1 = 1024,dropout=0.5,lr=0.001,epochs=6):
